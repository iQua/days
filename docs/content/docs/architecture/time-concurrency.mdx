...
This is intended as a lightweight way to correlate workload shape with runtime behavior. For deeper investigations (event ordering, logging interleavings), see the design notes under [/docs/design-notes/pfc](/docs/design-notes/pfc) and `/docs/notes/*`.
