...
This page records the shared schema conventions used across trace families. It is adapted from the paper appendix `lean-paper/appendix-schema.tex` and reconciled with the current Rust logging structs in `days/src/utils/logger.rs`.
