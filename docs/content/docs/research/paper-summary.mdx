---
title: Paper summary
description: High-level summary of the LeanGuard/Days research narrative (from lean-paper/).
---

The `lean-paper/` directory contains the LaTeX source for a research paper describing **LeanGuard** (a trace-certificate conformance-checking framework) and its implementation inside **Days**.

This page is a docs-friendly summary of the main ideas.
...
- [/docs/notes/test-generation](/docs/notes/test-generation) (engineering note)
...
See `lean-paper/experiments.tex` for details.
