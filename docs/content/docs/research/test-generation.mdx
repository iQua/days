...
This page adapts the paper’s test-generation section (`lean-paper/generation.tex`) into docs form.

If you want the *implementation plan and knobs*, see the migrated engineering note:

- [/docs/notes/test-generation](/docs/notes/test-generation)
