---
title: Coverage-guided test generation (note)
description: Engineering plan for LeanGuard-driven scenario generation, coverage, and minimization.
---

> **Note**: Migrated from `days/ideas/test-generation.md`. This is an engineering/research note and may be outdated.
