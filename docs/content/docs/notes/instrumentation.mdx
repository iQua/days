---
title: Instrumentation plan (note)
description: Low-intrusion counters and timers to understand contention and executor behavior.
---

> **Note**: Migrated from `days/ideas/instrumentation.md`. This is an engineering note and may be outdated.
