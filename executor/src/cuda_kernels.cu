...
// `lp_state` word 0. The tagged `L_ERROR_ARENA` word remains the cumulative successful-attempt
// continuation count; an actual capacity error overwrites it and terminates the attempt.
//
