...
use days_legacy::flows::cc::CCAlgorithm::TCPCubic;
use days_legacy::flows::flow::FlowType;
use days_legacy::flows::packet::EcnField;
use days_legacy::flows::sink::PacketSink;
use days_legacy::flows::source::PacketSource;
use days_legacy::flows::{DistributionInfo, TCPCharacteristics, TrafficCharacteristics};
...
impl EcnCounter {
    ...
    async fn packet_received(
        &mut self,
        packet: days_legacy::flows::packet::Packet,
        _: &Context<Self>,
    ) {
        if self.count_data {
